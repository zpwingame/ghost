...
_vue2.default.component('my-component1', {
...
_vue2.default.component("component-demo", {
    ...
    methods: {
        incrementss: function incrementss() {
            this.$emit('increment');
            this.total += 1;
        }
    },
...
window.vm = new _vue2.default({
    ...
    watch: {
        ...
        'tt.name': function ttName(newValue, oldValue) {
            console.log('new value is' + newValue + 'and old value is' + oldValue);
        }
    },
    computed: {
    ...
    filters: {
        toLowerCase: function toLowerCase(v) {
